%% FFTsandbox.m
% From MathWorks help on FFT
% Generates a sine wave of known amplitude and phase, then takes FFT

%% Generate sine wave of known freq/mag/phase
...
% Plot t he noisy signal in the time domain. It is difficult to identify
...
%% Fourier transform of original, uncorrupted signal
Y = fft(S);
P2 = abs(Y/L);
P1 = P2(1:L/2+1);
P1(2:end-1) = 2*P1(2:end-1);
